...
Deactivate up to 50 users, identified by email address. Deactivated users can no longer sign in and their active sessions are invalidated. They are not deleted and can be restored with [Activate Users](./activate-users.md).

<div class="apidocs-header">
    <div class="method delete">DELETE</div>
    <div class="endpoint">/api/public/users/deactivate</div>
</div>
...
<table>
    ...
    <tr>
        ...
        <td>Email addresses of the users to deactivate. Only the first 50 entries are processed.</td>
    </tr>
</table>
...
<table>
    ...
    <tr>
        <td>users_success</td>
        <td>Array of String</td>
        <td>Emails of users that were deactivated.</td>
    </tr>
    <tr>
        <td>users_invalid</td>
        <td>Array of String</td>
    ...
    <tr>
        <td>users_failed</td>
        <td>Array of String</td>
        <td>Users for whom deactivation failed.</td>
    </tr>
</table>
